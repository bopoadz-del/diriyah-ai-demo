...
const Settings = ({ userId = "user1" }) => {
  ...
  const savePrefs = async () => {
    try {
      ...
      setStatus("Unable to save preferences. Please try again.");
    }
  };
  ...
  return (
    <div className="settings-panel">
      ...
      <label className="settings-field">
        ...
        <input
          type="checkbox"
          checked={Boolean(prefs.alerts)}
          onChange={(event) => updatePref("alerts", event.target.checked)}
        />
      </label>
